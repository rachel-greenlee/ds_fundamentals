...
**Deviance** refers to residual deviance and null deviance, which is shown on an R output of a logistic regression. It's also accompanied by the degrees of freedom (number of predictors).  
